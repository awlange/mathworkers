...
MW.batch = {
     ...
     * @param {boolean} [rebroadcast] If true, the coordinator broadcasts the result back to the workers.
     */
    workerVectorLinearCombination: function (vectors, coefficients, tag, rebroadcast) {
     ...
     * @param {boolean} [rebroadcast] If true, the coordinator broadcasts the result back to the workers.
     */
    workerMatrixLinearCombination: function(matrices, coefficients, tag, rebroadcast) {
        MW.util.checkNumber(coefficients[0]);
     ...
     */
    workerMatrixVectorPlus: function(alpha, A, x, tag, rebroadcast, beta, y) {
        MW.util.checkNumber(alpha);
     ...
     */
    workerMatrixMatrixPlus: function(alpha, A, B, tag, rebroadcast, beta, C) {
        MW.util.checkNumber(alpha);
